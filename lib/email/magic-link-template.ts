...
const i18n: Record<string, Lang> = {
  en: {
    ...
    cta: 'Sign in',
    ctaHint: 'This link expires in 48 hours and is single-use. Open it on the device where you want to sign in.',
  ...
  pt: {
    ...
    cta: 'Entrar',
    ctaHint: 'Este link expira em 48 horas e é de uso único. Abra-o no dispositivo em que deseja entrar.',
  ...
  es: {
    subject: 'Iniciar sesión en AskMoses',
    ...
    cta: 'Iniciar sesión',
    ctaHint: 'Este enlace caduca en 48 horas y es de un solo uso. Ábrelo en el dispositivo donde quieras iniciar sesión.',
  ...
  fr: {
    subject: 'Se connecter à AskMoses',
    ...
    cta: 'Se connecter',
    ctaHint: 'Ce lien expire dans 48 heures et est à usage unique. Ouvrez-le sur l\'appareil avec lequel vous souhaitez vous connecter.',
