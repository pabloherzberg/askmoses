...
function scoreColor(display: number): string {
  if (display >= 9) return '#22D9A0'
  if (display >= 7) return '#FFAB2E'
  return '#FF5E5E'
}
...
function progressBar(display: number): string {
  ...
  const emptyCells = Array(empty).fill(
    `<td width="14" height="14" bgcolor="#222736" style="border-radius:2px;font-size:1px;">&nbsp;</td><td width="2" style="font-size:1px;">&nbsp;</td>`
  ).join('')
...
function sectionRow(section: CoachingEmailSection): string {
  ...
  const borderColor = isCritical ? '#FF5E5E' : '#1A1E28'
  const color = scoreColor(display)
  ...
  return `
    <tr>
      <td style="padding: 0 0 8px 0;">
        <table border="0" cellpadding="12" cellspacing="0" width="100%" style="background-color:#1A1E28;border-radius:8px;border-left:3px solid ${borderColor};">
          <tr>
            <td>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="font-family:'DM Sans',Arial,sans-serif;font-size:14px;color:#F0F2F8;font-weight:600;">
                    ${section.name}${bdg}
                  </td>
...
function bulletList(items: string[], limit = 3): string {
  return items
    ...
    .map(item => `
      <tr>
        <td style="padding: 4px 0; font-family:'DM Sans',Arial,sans-serif;font-size:14px;color:#D0D4E0;line-height:1.5;">
          • ${item}
        </td>
      </tr>`)
    .join('')
...
export function buildCoachingEmail(data: CoachingEmailData): { subject: string; html: string } {
  ...
  const criticalNote = worstSection && toDisplay(worstSection.score) <= 4
    ? `<tr><td style="padding:12px 0 0 0;font-family:'DM Sans',Arial,sans-serif;font-size:13px;color:#FF5E5E;">⚠️ ${worstSection.name} — focus here this week.</td></tr>`
    : ''
...
<body style="margin:0;padding:0;background-color:#0D0F14;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#0D0F14;">
    <tr>
      <td align="center" style="padding:24px 16px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;width:100%;">
          ...
          <!-- Header -->
          <tr>
            <td style="background-color:#13161D;border-radius:12px 12px 0 0;padding:24px 28px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td>
                    <p style="margin:0;font-family:'DM Sans',Arial,sans-serif;font-size:12px;color:#7A849A;letter-spacing:1px;text-transform:uppercase;">AskMoses.AI</p>
                    <h1 style="margin:4px 0 0 0;font-family:'DM Sans',Arial,sans-serif;font-size:20px;font-weight:700;color:#F0F2F8;">
                  ...
                  <td align="right" style="white-space:nowrap;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background-color:#6E56FF;border-radius:8px;padding:8px 16px;">
          ...
          <!-- Sections -->
          <tr>
            <td style="background-color:#13161D;padding:4px 28px 20px 28px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <!-- Divider -->
          <tr>
            <td style="background-color:#13161D;padding:0 28px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr><td height="1" bgcolor="#222736" style="font-size:1px;">&nbsp;</td></tr>
              </table>
            </td>
          </tr>
          ...
          <!-- Strengths -->
          <tr>
            <td style="background-color:#13161D;padding:20px 28px 12px 28px;">
              <p style="margin:0 0 12px 0;font-family:'DM Sans',Arial,sans-serif;font-size:15px;font-weight:700;color:#22D9A0;">✅ ${lang.wellDone}</p>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <!-- Improvements -->
          <tr>
            <td style="background-color:#13161D;padding:20px 28px 24px 28px;border-radius:0 0 12px 12px;">
              <p style="margin:0 0 12px 0;font-family:'DM Sans',Arial,sans-serif;font-size:15px;font-weight:700;color:#FFAB2E;">📈 ${lang.improve}</p>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
