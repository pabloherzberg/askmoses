...
import { COST_PER_MINUTE_USD } from '@/lib/utils'
...
export const clients: Client[] = [
  {
    ...
    callsThisMonth: 20,
    avgScore: 84,
    totalMinutesThisMonth: 620,
    totalCostThisMonth: 620 * COST_PER_MINUTE_USD,
    health: 'healthy',
    trainersCount: 4,
    ownerAccepted: true,
  ...
  },
  {
    ...
    callsThisMonth: 35,
    avgScore: 88,
    totalMinutesThisMonth: 1100,
    totalCostThisMonth: 1100 * COST_PER_MINUTE_USD,
    health: 'healthy',
    trainersCount: 4,
    ownerAccepted: true,
    subscriptionStatus: 'active',
  ...
  },
  {
    ...
    callsThisMonth: 8,
    avgScore: 72,
    totalMinutesThisMonth: 240,
    totalCostThisMonth: 240 * COST_PER_MINUTE_USD,
    health: 'at-risk',
    trainersCount: 4,
    ownerAccepted: true,
    subscriptionStatus: 'active',
...
export const globalMetrics: GlobalMetrics = {
  ...
  totalMinutesThisMonth: 1960,
  totalCostThisMonth: 1960 * COST_PER_MINUTE_USD,
  avgScore: 82,
}
...
export const supabaseCalls = calls.map((call) => ({
  ...
  // Duração em segundos — fonte de `durationMinutes` no mapper toCall
  // (lib/services/calls.ts). Deriva dos minutos do mock pra manter consistência.
...
export const performanceTrends: Record<string, PerformanceTrendPoint[]> = {
  ...
  '00000000-0000-0000-0000-000000000301': [ // Marcus R.
    ...
    { week: 'W6', closeRate: 74, avgScore: 92 },
  ],
  '00000000-0000-0000-0000-000000000302': [ // Jamie L.
    { week: 'W1', closeRate: 55, avgScore: 70 },
    { week: 'W2', closeRate: 57, avgScore: 74 },
    { week: 'W3', closeRate: 60, avgScore: 76 },
    { week: 'W4', closeRate: 62, avgScore: 78 },
    { week: 'W5', closeRate: 65, avgScore: 82 },
  ...
  '00000000-0000-0000-0000-000000000303': [ // Jordan K.
    ...
    { week: 'W3', closeRate: 56, avgScore: 74 },
    { week: 'W4', closeRate: 58, avgScore: 76 },
    { week: 'W5', closeRate: 60, avgScore: 80 },
    { week: 'W6', closeRate: 61, avgScore: 82 },
  ],
  '00000000-0000-0000-0000-000000000304': [ // Taylor M.
    { week: 'W1', closeRate: 59, avgScore: 74 },
    { week: 'W2', closeRate: 58, avgScore: 74 },
    { week: 'W3', closeRate: 57, avgScore: 72 },
    { week: 'W4', closeRate: 56, avgScore: 70 },
    { week: 'W5', closeRate: 55, avgScore: 68 },
    { week: 'W6', closeRate: 55, avgScore: 66 },
  ],
  team: [ // aggregate average across all sales people
    { week: 'W1', closeRate: 56, avgScore: 72 },
    { week: 'W2', closeRate: 58, avgScore: 74 },
    { week: 'W3', closeRate: 60, avgScore: 76 },
    { week: 'W4', closeRate: 61, avgScore: 78 },
    { week: 'W5', closeRate: 63, avgScore: 80 },
    { week: 'W6', closeRate: 65, avgScore: 82 },
  ],
}
