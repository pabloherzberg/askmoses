        ...
        adminLabels={{
          ...
          table: {
            ...
            dialog: {
              ...
              statusLabel: t('editRate.statusLabel'),
              statusHint: t('editRate.statusHint'),
              status_PAID: t('editRate.status_PAID'),
              status_PILOT: t('editRate.status_PILOT'),
              status_DEMO: t('editRate.status_DEMO'),
              status_DISABLED: t('editRate.status_DISABLED'),
