...
export default function AdminRubricPage() {
  ...
  async function handleCreateScript() {
    if (!newScriptForm.name || !newScriptForm.description) return
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                {(() => {
                  ...
                  return (
                    <Button onClick={handleCreateScript} disabled={!newScriptForm.name || !newScriptForm.description || weightInvalid} className="cursor-pointer">
