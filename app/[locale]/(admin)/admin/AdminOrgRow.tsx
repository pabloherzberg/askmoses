...
export function AdminOrgRow({ client, isLast, styles, statusLabel }: Props) {
  ...
  return (
    ...
    >
      ...
      <td className="px-5 py-4">
        <span
          className="text-[11px] font-medium px-2 py-0.5 rounded-full font-mono uppercase tracking-wide"
