...
--
-- Com a validação anti-eco (§3.2.1), esse caso já fica raro, mas persistir o
-- bruto ANTES de limpar os chunks é a defesa que fecha o risco de vez —
-- mesmo uma falha de validação futura não descarta o dado original.
--
