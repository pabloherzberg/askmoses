...
const CTA_COLORS: Record<string, { color: string; border: string; bg: string }> = {
  'Reference call →': { color: 'var(--am-amber)',  border: 'rgba(255,171,46,0.4)',  bg: 'rgba(255,171,46,0.08)'  },
  'Share call →':     { color: 'var(--am-green)',  border: 'rgba(34,217,160,0.4)',  bg: 'rgba(34,217,160,0.08)'  },
  'View missing →':   { color: 'var(--am-accent2)',border: 'rgba(155,135,255,0.4)', bg: 'rgba(155,135,255,0.08)' },
  'View calls →':     { color: 'var(--am-blue)',   border: 'rgba(94,179,255,0.4)',  bg: 'rgba(94,179,255,0.08)'  },
  'View script →':    { color: 'var(--am-muted)',  border: 'rgba(122,132,154,0.4)', bg: 'rgba(122,132,154,0.08)' },
}
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[13px] font-semibold leading-snug" style={{ color: 'var(--am-text)' }}>
                  {rec.title}
                </p>
                <p className="text-[12px] mt-0.5 leading-relaxed" style={{ color: 'var(--am-muted)' }}>
                  {rec.text}
                </p>
              </div>
      ...
      <p className="mt-4 text-[10px]" style={{ color: 'var(--am-amber)' }}>
        † all values from mock-data.ts — CTAs are non-functional in demo · no real AI logic
      </p>
    </div>
  )
}
